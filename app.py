...
CORS(app, origins="*")  # <-- allow all origins; or replace "*" with your GitHub Pages URL
...
def get_snake_body():
    return jsonify({"segments": snake_body, "bulge_index": bulge_index})
